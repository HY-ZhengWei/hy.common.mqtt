 ...
 * @version     v1.0
 */
public class MqttMessageV5 implements IMqttMessage ,Serializable
{
    
    private static final long serialVersionUID = -7349623182961993041L;
    ...
    public MqttMessageV5(MqttMessage i_V5)
    {
        this.message = i_V5;
    }
